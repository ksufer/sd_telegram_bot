...
架构要点：
- 会话存 bot_data["_prompt_chat"][user_id] = {"mode": "t2i"|"krea2", "nsfw": bool,
...
MODE_LABEL = {"t2i": "🛠 通用 T2I 优化", "krea2": "🎨 Krea 2 设计"}
...
def get_handlers() -> list:
    return [
        ...
        CallbackQueryHandler(auth_callback(prompt_chat_mode), pattern=r"^prompt_chat:mode:(t2i|krea2)$"),
